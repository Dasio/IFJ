...
char *stringifyInstructionPtr(InstrFuncPtr ptr) {
		if(*ptr == Instr_NEG_LCII) return "Instr_NEG_LCII";
		if(*ptr == Instr_NEG_LCID) return "Instr_NEG_LCID";
		if(*ptr == Instr_NEG_LCIB) return "Instr_NEG_LCIB";
		if(*ptr == Instr_NEG_LCIS) return "Instr_NEG_LCIS";
		if(*ptr == Instr_NEG_LCDI) return "Instr_NEG_LCDI";
		if(*ptr == Instr_NEG_LCDD) return "Instr_NEG_LCDD";
		if(*ptr == Instr_NEG_LCDB) return "Instr_NEG_LCDB";
		if(*ptr == Instr_NEG_LCDS) return "Instr_NEG_LCDS";
		if(*ptr == Instr_NEG_LLII) return "Instr_NEG_LLII";
		if(*ptr == Instr_NEG_LLID) return "Instr_NEG_LLID";
		if(*ptr == Instr_NEG_LLIB) return "Instr_NEG_LLIB";
		if(*ptr == Instr_NEG_LLIS) return "Instr_NEG_LLIS";
		if(*ptr == Instr_NEG_LLDI) return "Instr_NEG_LLDI";
		if(*ptr == Instr_NEG_LLDD) return "Instr_NEG_LLDD";
		if(*ptr == Instr_NEG_LLDB) return "Instr_NEG_LLDB";
		if(*ptr == Instr_NEG_LLDS) return "Instr_NEG_LLDS";
		if(*ptr == Instr_NEG_LGII) return "Instr_NEG_LGII";
		if(*ptr == Instr_NEG_LGID) return "Instr_NEG_LGID";
		if(*ptr == Instr_NEG_LGIB) return "Instr_NEG_LGIB";
		if(*ptr == Instr_NEG_LGIS) return "Instr_NEG_LGIS";
		if(*ptr == Instr_NEG_LGDI) return "Instr_NEG_LGDI";
		if(*ptr == Instr_NEG_LGDD) return "Instr_NEG_LGDD";
		if(*ptr == Instr_NEG_LGDB) return "Instr_NEG_LGDB";
		if(*ptr == Instr_NEG_LGDS) return "Instr_NEG_LGDS";
		if(*ptr == Instr_NEG_GCII) return "Instr_NEG_GCII";
		if(*ptr == Instr_NEG_GCID) return "Instr_NEG_GCID";
		if(*ptr == Instr_NEG_GCIB) return "Instr_NEG_GCIB";
		if(*ptr == Instr_NEG_GCIS) return "Instr_NEG_GCIS";
		if(*ptr == Instr_NEG_GCDI) return "Instr_NEG_GCDI";
		if(*ptr == Instr_NEG_GCDD) return "Instr_NEG_GCDD";
		if(*ptr == Instr_NEG_GCDB) return "Instr_NEG_GCDB";
		if(*ptr == Instr_NEG_GCDS) return "Instr_NEG_GCDS";
		if(*ptr == Instr_NEG_GLII) return "Instr_NEG_GLII";
		if(*ptr == Instr_NEG_GLID) return "Instr_NEG_GLID";
		if(*ptr == Instr_NEG_GLIB) return "Instr_NEG_GLIB";
		if(*ptr == Instr_NEG_GLIS) return "Instr_NEG_GLIS";
		if(*ptr == Instr_NEG_GLDI) return "Instr_NEG_GLDI";
		if(*ptr == Instr_NEG_GLDD) return "Instr_NEG_GLDD";
		if(*ptr == Instr_NEG_GLDB) return "Instr_NEG_GLDB";
		if(*ptr == Instr_NEG_GLDS) return "Instr_NEG_GLDS";
		if(*ptr == Instr_NEG_GGII) return "Instr_NEG_GGII";
		if(*ptr == Instr_NEG_GGID) return "Instr_NEG_GGID";
		if(*ptr == Instr_NEG_GGIB) return "Instr_NEG_GGIB";
		if(*ptr == Instr_NEG_GGIS) return "Instr_NEG_GGIS";
		if(*ptr == Instr_NEG_GGDI) return "Instr_NEG_GGDI";
		if(*ptr == Instr_NEG_GGDD) return "Instr_NEG_GGDD";
		if(*ptr == Instr_NEG_GGDB) return "Instr_NEG_GGDB";
		if(*ptr == Instr_NEG_GGDS) return "Instr_NEG_GGDS";
		if(*ptr == Instr_NOT_LCBI) return "Instr_NOT_LCBI";
		if(*ptr == Instr_NOT_LCBD) return "Instr_NOT_LCBD";
		if(*ptr == Instr_NOT_LCBB) return "Instr_NOT_LCBB";
		if(*ptr == Instr_NOT_LCBS) return "Instr_NOT_LCBS";
		if(*ptr == Instr_NOT_LLBI) return "Instr_NOT_LLBI";
		if(*ptr == Instr_NOT_LLBD) return "Instr_NOT_LLBD";
		if(*ptr == Instr_NOT_LLBB) return "Instr_NOT_LLBB";
		if(*ptr == Instr_NOT_LLBS) return "Instr_NOT_LLBS";
		if(*ptr == Instr_NOT_LGBI) return "Instr_NOT_LGBI";
		if(*ptr == Instr_NOT_LGBD) return "Instr_NOT_LGBD";
		if(*ptr == Instr_NOT_LGBB) return "Instr_NOT_LGBB";
		if(*ptr == Instr_NOT_LGBS) return "Instr_NOT_LGBS";
		if(*ptr == Instr_NOT_GCBI) return "Instr_NOT_GCBI";
		if(*ptr == Instr_NOT_GCBD) return "Instr_NOT_GCBD";
		if(*ptr == Instr_NOT_GCBB) return "Instr_NOT_GCBB";
		if(*ptr == Instr_NOT_GCBS) return "Instr_NOT_GCBS";
		if(*ptr == Instr_NOT_GLBI) return "Instr_NOT_GLBI";
		if(*ptr == Instr_NOT_GLBD) return "Instr_NOT_GLBD";
		if(*ptr == Instr_NOT_GLBB) return "Instr_NOT_GLBB";
		if(*ptr == Instr_NOT_GLBS) return "Instr_NOT_GLBS";
		if(*ptr == Instr_NOT_GGBI) return "Instr_NOT_GGBI";
		if(*ptr == Instr_NOT_GGBD) return "Instr_NOT_GGBD";
		if(*ptr == Instr_NOT_GGBB) return "Instr_NOT_GGBB";
		if(*ptr == Instr_NOT_GGBS) return "Instr_NOT_GGBS";
