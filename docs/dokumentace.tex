...
Počas riešenia projektu boli 4 schôdze celého tímu, kde sa stanovil plán na
nadchádzajúce týždne, pričom prvá schôdza bola \todo[inline]{Doplnit datum}.
...
bol problém časová náročnosť projektu a náväznosť na prednášky, tak sme sa
...
\begin{table}[H]
	\centering
	\begin{tabular}{rl}
		Dávid Mikúš        & Vedúci tímu, parser, testovanie \\
		Peter Hostačný     & Vyhodnocovanie výrazov, testovanie \\
		Tomáš Kello        & Algoritmy, pomocné štruktúry \\
